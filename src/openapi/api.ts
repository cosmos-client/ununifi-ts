...
export const QueryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listedNfts(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListedNfts200Response>> {
...
export class QueryApi extends BaseAPI {
    ...
    public listedNfts(options?: AxiosRequestConfig) {
        return QueryApiFp(this.configuration).listedNfts(options).then((request) => request(this.axios, this.basePath));
    }
