...
export function estimateMintLiquidityPoolToken(sdk: cosmosclient.CosmosSDK, poolId: string, amount: string) {
  return new QueryApi(undefined, sdk.url).estimateMintLiquidityPoolToken(poolId, amount);
}
